...
const STATUS_BADGE: Record<string, { label: string; className: string }> = {
  ACTIVE: { label: '활성', className: 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400' },
  PAUSED: { label: '일시정지', className: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-400' },
  CANCELLED: { label: '해지', className: 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-400' },
};
...
export default function SubscriptionCard({ subscription, onEdit }: Props) {
  ...
  const bgColor = subscription.color ?? '#6d28d9';
